  ...
  return (
    <div className="volunteer">
      ...
      <p className="volunteer-text mb-5">
        ...
        is one of the ways to support Ukraine in this illegal war that Russia is
        waging against us. We are a non-party and non-religious organization,
        the main tasks of which are to conduct social, informational and
        charitable activities, to provide financial, humanitarian and
        informational support to both individuals and legal entities that
        legally conduct activities and respect democratic values, to conduct
        informational work regarding Ukraine with the aim of dissemination of
        knowledge about Ukraine and its culture, as well as coverage of topical
      ...
      <ul>
        <li>
          Information work and dissemination of information in social networks,
          at rallies and various events, at workplaces, as well as among
      ...
      <p className="fw-semibold as-text">
        ...
        help choose the direction of volunteering if necessary.
      </p>
